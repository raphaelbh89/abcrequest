    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center space-y-3">
          ...
          <p className="text-slate-500 text-xs font-medium">Đang tải trang yêu cầu đồ dùng...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-bold bg-emerald-50 text-emerald-700 border border-emerald-200 mb-2">
              ...
              <span>Theo dõi & Duyệt yêu cầu</span>
            </div>
            <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">
              Danh Sách Yêu Cầu Đồ Dùng
            </h1>
            <p className="text-xs sm:text-sm text-slate-500 mt-1">
              Theo dõi trạng thái duyệt, số lượng phân bổ từ kho và xuất phiếu Excel (.xlsx) chuẩn.
            </p>
          </div>
        </div>
